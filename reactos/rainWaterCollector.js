...
console.log(`collection device "a" can hold`, rainCollector(a))

// // vol = 6
const b = [0, 1, 0, 2, 1, 0, 1, 3, 2, 1, 2, 1]
console.log(`collection device "b" can hold`, rainCollector(b))

// // vol = 12
const c = [0, 3, 0, 1, 0, 0, 0, 1, 0, 2]
console.log(`collection device "c" can hold`, rainCollector(c))

// // vol = 8
const d = [0, 1, 0, 3, 5, 0, 0, 0, 2, 0, 1]
console.log(`collection device "d" can hold`, rainCollector(d))

// // vol = 38
const e = [0, 5, 3, 2, 8, 8, 1, 1, 2, 4, 3, 3, 7, 1, 2, 4, 3, 2]
console.log(`collection device "e" can hold`, rainCollector(e))
